...
rpe = Robust_pol_Kl_uncertainity(nS, nA, cost_list, init_dist, alpha=0.001)
...
with open("Value_function_kl_lambda_Gar_CRPO_"+str(nS)+"_"+str(nA)+"_"+str(kl_lambda)+".pkl","wb") as f:
    pickle.dump(vf,f)
f.close()

with open("Cost_function_kl_lambda_Gar_CRPO_"+str(nS)+"_"+str(nA)+"_"+str(kl_lambda)+".pkl","wb") as f:
    pickle.dump(cf,f)
f.close()
# Final policy
