...
plt.title('Comparison of behaviour for different values of lambda in RPNG',fontsize=18)
...
plt.title('Comparison of behaviour for different values of lambda in RNPG',fontsize=18)
